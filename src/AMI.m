% =======================================================================================
% Note that this matlab script file has not been used anymore. Its unique utility would be
%  to allows us to compare our AMI calculation in 'src/compare-partitions.R' with 
% the results obtained by this script.
%
% This script file was retrieved from the website indicated by the following paper:
%   Vinh et al. Information Theoretic Measures for Clusterings Comparison: Is a Correction for Chance Necessary? 2009.
%   DOI: https://doi.org/10.1145/1553374.1553511
% =======================================================================================
%
%
